...
<body>
	...
	<!-- 以下为 s:date 标签的使用介绍 -->
	以下为 s:date 标签的使用介绍 <hr/>
	
	s:date: 可以对 Date 对象进行排版
	<br/><br/>

	<!-- format 为对 name 指定的 date 进行排版，formar 为排版的格式指定，var 为排版完成的新的 date 对象 -->
	...
	<s:iterator value="persons"> 
		<!-- a标签中不支持 OGNL解析，需要进行强制的 OGNL 解析，写法如下 -->
		<!-- 可以为使用  %{} 把属性包装起来，使其进行强制的 OGNL 解析 -->
